...
if ($count != 0)
	...
	do 
		...
		$i_dibaca_postdate = balikin($data['dibaca_postdate']);
		
		
		//set udah dibaca
		mysqli_query($koneksi, "UPDATE user_log_entri SET dibaca = 'true', ".
