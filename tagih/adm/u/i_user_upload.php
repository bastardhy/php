...
$foldernya = "../../filebox/user/$kd/";
			
			
//buat folder...
if (!file_exists('../../filebox/user/'.$kd.'')) {
    mkdir('../../filebox/user/'.$kd.'', 0777, true);
	}
...
{
 $name = balikin(strtolower($_FILES["image_upload"]["name"]));
