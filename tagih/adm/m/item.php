			    ...
			    if ($i > 1) 
			    	{
				      ...
				      $i_harga = cegah($sheet['D']);
				      $i_satuan = cegah($sheet['E']);
					...
					mysqli_query($koneksi, "INSERT INTO m_item(kd, kode, nama, ".
											"harga, satuan, postdate) VALUES ".
											"('$i_xyz', '$i_kode', '$i_nama', ".
											"'$i_harga', '$i_satuan', '$today')");
...
if (($s == "baru") OR ($s == "edit"))
	...
	$e_harga = balikin($rowx['harga']);
	$e_satuan = balikin($rowx['satuan']);
	...
	$(document).ready(function () {
		...
		$('#e_harga').bind('keyup paste', function(){
	...
	KODE : 
	<br>
	<input name="e_kode" type="text" value="'.$e_kode.'" size="30" class="btn-warning">
	</p>
	...
	HARGA : 
	<br>
	Rp.<input name="e_harga" id="e_harga" type="text" value="'.$e_harga.'" size="15" class="btn-warning">,-
	</p>
	...
	SATUAN :
	<br>
	<select name="e_satuan" id="e_satuan" class="btn btn-warning">
	<option value="'.$e_satuan.'" selected>'.$e_satuan.'</option>';
	...
	do
		...
		echo '<option value="'.$st_nama2.'">'.$st_nama1.'</option>';
		}
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>  
   ...
   <hr>';
	...
	$(document).ready(function(){
	       ...
	       $('#image-holder').load("<?php echo $sumber;?>/adm/m/i_item.php?aksi=lihat1&kd=<?php echo $kd;?>");
	    ...
	    $('#upload_image').on('change', function(event){
	     event.preventDefault();
			...
			$('#loading').show();
		     ...
		     $.ajax({
		      url:"i_item_upload.php?kd=<?php echo $kd;?>",
		      method:"POST",
		      ...
		      success:function(data){
				$('#loading').hide();
		       $('#preview').load("<?php echo $sumber;?>/adm/m/i_item.php?aksi=lihat&kd=<?php echo $kd;?>");
