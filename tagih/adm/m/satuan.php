...
if ($_POST['btnSMP'])
	...
	if (empty($e_nama))
		...
		if ($s == "baru")
			{
			//insert
			mysqli_query($koneksi, "INSERT INTO m_satuan(kd, nama, postdate) VALUES ".
							"('$e_kd', '$e_nama', '$today')");
		...
		if ($s == "edit")
			{
			mysqli_query($koneksi, "UPDATE m_satuan SET nama = '$e_nama', ".
									"postdate = '$today' ".
									"WHERE kd = '$e_kd'");
	...
	echo '<div class="table-responsive">          
		  <table class="table" border="1">
		    <thead>
				...
				<td width="16">&nbsp;</td>
				<td width="30">&nbsp;</td>
				<td><strong><font color="'.$warnatext.'">NAMA SATUAN</font></strong></td>
				</tr>
