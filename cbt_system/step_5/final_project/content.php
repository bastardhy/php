...
if ($_GET['module']=='home'){
  if ($_SESSION['leveluser']=='admin'){
	...
	echo"<br><div class='row'>
        	<div class='col-sm-4'>
			<p align=center><h3>Welcome</h3></p> 
			<p><h3>Computer Based Test</h3></p>
        </div>
        <div class='col-sm-4'>
        ...
        <div class='col-sm-4'>
         <img src='images/logo.jpg' alt='' width='100%' class='hidden-phone'>
        </div>
      </div>";	
	...
	echo"<br><div class='row'>
      ...
      <div id='carousel-example-generic' class='carousel slide' data-ride='carousel'>
        ...
        <div class='carousel-inner' role='listbox'>
          <div class='item active'>
            <img src='images/slides/slide5.jpg' alt='First slide'>
          </div>
          <div class='item'>
            <img src='images/slides/slide1.jpg' alt='First slide'>
          </div>
	...
	$tgl=tgl_indo(date("Y m d")); 
        ...
        <div class='col-sm-5'>
Hai <b>$_SESSION[namalengkap]</b>, selamat datang di halaman Test Berbasis Komputer (CBT). 
