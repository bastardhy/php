    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href ="media.php?module=home"><img src="images/logo.png" height="41"></a>
...
<!--/.Bagian Isi -->
    ...
    <?php include "content.php"; ?>
        ...
        <footer class="footer">
      <div class="container">
        <p><a href="http://imagomedia.co.id/" target="_blank" title="Computer Based Test">Copyright@2016 Imago Media</a>. Developed by <a href="http://blog.imagomedia.co.id/" target="_top" title="Computer Based Test">Blog.Imago Media</a>.<br></p>
      </div>
    </footer>
