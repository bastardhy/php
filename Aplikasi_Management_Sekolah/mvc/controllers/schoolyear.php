...
*/
	...
	protected function rules() {
		if($this->data['siteinfos']->school_type == 'classbase') {
			$titletext = $this->lang->line("schoolyear_schoolyeartitle");
			$titlerules = 'trim|xss_clean|max_length[128]||callback_unique_schoolyeartitle';
			$semestercoderules = 'trim|xss_clean|max_length[11]|numeric'; 

		} else {
			$titletext = $this->lang->line("schoolyear_semestertitle");
			$titlerules = 'trim|required|xss_clean|max_length[128]||callback_unique_schoolyeartitle';
			$semestercoderules = 'trim|required|xss_clean|max_length[11]|numeric|callback_valid_number';
		}
	...
	public function delete() {
		...
		if((int)$id) {
			...
			if($schoolyear) {
				if($schoolyear->schoolyearID != 1 && $schoolyear->schoolyearID != 2) {
