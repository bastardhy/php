...
class Invoice_m extends MY_Model {
	...
	function get_invoice_with_studentrelation() {
		...
		$this->db->join('studentrelation', 'studentrelation.srstudentID = invoice.studentID && studentrelation.srclassesID = invoice.classesID && studentrelation.srschoolyearID = invoice.schoolyearID', 'LEFT');
