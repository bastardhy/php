    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if(permissionChecker('holiday_add')) { ?>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <?php if(permissionChecker('holiday_edit') || permissionChecker('holiday_delete') || permissionChecker('holiday_view')) { ?> 
                            ...
                            <?php if(count($holidays)) {$i = 1; foreach($holidays as $holiday) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                       ...
                                       <?php echo btn_edit('holiday/edit/'.$holiday->holidayID, $this->lang->line('edit')); ?>
