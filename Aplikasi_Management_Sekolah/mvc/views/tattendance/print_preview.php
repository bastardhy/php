    ...
    <div id="page-wrap">
          ...
          <tr>
            ...
            <td width="80%">
              <table>
                <tr>
                  <td>
                      <h3 style="margin:0px;"> <strong><?php  echo $teacher->name; ?></strong></h3>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h5 style="margin:0px;"> <strong><?=$teacher->designation?></strong>
                    </h5>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h5 style="margin:0px;"> <strong><?php  echo $this->lang->line("tattendance_email")." ".$teacher->email; ?></strong>
                    </h5>
                  </td>
                </tr>
              </table>
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("tattendance_dob")?></th>
              <td width="60%"><?php  echo $teacher->dob; ?></td>
          </tr>

          <tr>
              <th width="40%"><?=$this->lang->line("tattendance_sex")?></th>
              <td width="60%"><?php  echo $teacher->sex; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("tattendance_religion")?></th>
              <td width="60%"><?php  echo $teacher->religion; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("tattendance_email")?></th>
              <td width="60%"><?php  echo $teacher->email; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("tattendance_phone")?></th>
              <td width="60%"><?php  echo $teacher->phone; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("tattendance_address")?></th>
              <td width="60%"><?php  echo $teacher->address; ?></td>
          </tr>
        </tbody>
      </table>
