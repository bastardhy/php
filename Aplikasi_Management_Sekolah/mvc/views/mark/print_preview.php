    ...
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("mark_registerNO")?></th>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("mark_bloodgroup")?></th>
          ...
          <tr>
              <th width="40%"><?=$this->lang->line("mark_state")?></th>
              <td width="60%"><?php echo $student->state; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$this->lang->line("mark_country")?></th>
