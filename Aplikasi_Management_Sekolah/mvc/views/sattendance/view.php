            ...
            <div class="panel-body profile-view-dis">
                ...
                <div class="row">
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("attendance_registerNO")?> </span>: <?=$student->registerNO?></p>
                    </div>
                    <div class="profile-view-tab">
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("attendance_bloodgroup")?> </span>: <?php if(isset($allbloodgroup[$student->bloodgroup])) { echo $student->bloodgroup; } ?></p>
                    </div>
                    <div class="profile-view-tab">
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("attendance_state")?> </span>: <?=$student->state?></p>
                    </div>
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("attendance_country")?> </span>: <?php if(isset($allcountry[$student->country])) { echo $allcountry[$student->country]; } ?></p>
                    </div>
