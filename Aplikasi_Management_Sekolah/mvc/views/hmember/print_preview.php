    ...
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
          <tbody>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("hmember_registerNO")?></th>
            ...
            <tr>
                ...
                <td width="60%"><?php if($hmember->hjoindate) { echo date("d M Y", strtotime($hmember->hjoindate)); }  ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("hmember_bloodgroup")?></th>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("hmember_state")?></th>
                <td width="60%"><?php echo $student->state; ?></td>
            </tr>
            <tr>
                <th width="40%"><?=$this->lang->line("hmember_country")?></th>
