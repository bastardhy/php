                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="auto_invoice_generate" class="col-sm-2 control-label">
                            ...
                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Enable/Disable library fee, hostel fee, transport fee invoice in student account automatically. it's add monthly wise."></i>
                        </label>
                    ...
                    ?>
                        <label for="currency_code" class="col-sm-2 control-label">
                            ...
                            &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set organization currency code like USD or GBP"></i>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="currency_symbol" class="col-sm-2 control-label">
                            ...
                            &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set organization currency system here like $ or £"></i>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="lang" class="col-sm-2 control-label">
                            ...
                            &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Select organization default language here"></i>
                        </label>
                        <div class="col-sm-6">
                            <?php
                    ...
                    ?>
                        <label for="attendance" class="col-sm-2 control-label">
                            ...
                            &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Select school default attendance system"></i>
                        </label>
                        <div class="col-sm-6">
                            <?php
                    ...
                    ?>
                        <label for="school_year" class="col-sm-2 control-label">
                            ...
                            &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Select school running academic year"></i>
                        </label>
                        <div class="col-sm-6">
                            <?php
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">
                            <?=$this->lang->line("setting_school_marksetting")?><i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Active how many cagetory in mark system"></i>
                        </label>
                        <div class="col-sm-10">
                        <?php
