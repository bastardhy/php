    ...
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
          <tbody>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("lmember_registerNO")?></th>
            ...
            <tr>
                ...
                <td width="60%"><?php if($student->dob) { echo date("d M Y", strtotime($student->dob)); } else { echo ''; } ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("lmember_bloodgroup")?></th>
            ...
            <tr>
                <th width="40%"><?=$this->lang->line("lmember_state")?></th>
                <td width="60%"><?php echo $student->state; ?></td>
            </tr>
            <tr>
                <th width="40%"><?=$this->lang->line("lmember_country")?></th>
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            <td colspan="7"><h4><?=$this->lang->line("book_issue_history")?></h4></td>
          </tr>
            <tr>
