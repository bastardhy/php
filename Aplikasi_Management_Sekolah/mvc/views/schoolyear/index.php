...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">
            ...
            <?php 
                echo $this->lang->line('panel_title_'.$siteinfos->school_type);
            ?>
        </h3>

        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li class="active"><?=$this->lang->line('menu_schoolyear_'.$siteinfos->school_type)?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                    ...
                    <h5 class="page-header">
                        ...
                        ?>
                            <a href="<?php echo base_url('schoolyear/add') ?>">
                                ...
                                <?=$this->lang->line('add_title_'.$siteinfos->school_type)?>
                            </a>
                        <?php } ?>
                    </h5>
                            ...
                            <?php if(count($schoolyears)) {$i = 1; foreach($schoolyears as $schoolyear) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                        ...
                                        <?php if($schoolyear->schoolyearID !=1 && $schoolyear->schoolyearID !=2) { echo btn_delete('schoolyear/delete/'.$schoolyear->schoolyearID, $this->lang->line('delete')); }?>
                                    </td>
                                    <?php } ?>
                                </tr>
                            <?php $i++; }} ?>
