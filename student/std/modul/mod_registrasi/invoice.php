	...
	$content = "
				...
				<table cellpadding=0 cellspacing=0>
					<tr>
						...
						<th align='center' width='305' style='border: 1px solid #000; padding: 5px;font-size: 11.5px; background-color:#9CCC68;'>Nama MTK</th>
						<th width='110' align='center' style='border: 1px solid #000; padding: 5px;font-size: 11.5px; background-color:#9CCC68;'>Jumlah SKS</th>
					</tr>
			";
			$i = 1;
