...
<h1> Selamat,Transaksi sukses di lakukan</h1>
<h2> Kode Pesan :<?=$kd_pesan;?></h2>
<h2>Total Harga :<?=  $totalBayar;?></h2>
<h2> Biaya kirim :<?=$biaya;?></h2>
<h2>Total Transfer:<?=($totalBayar+$biaya)
?></h2>
<p>
